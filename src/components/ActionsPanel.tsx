...
const fields: Record<Department, [keyof ActionFormState,string,string][]> = {
  ...
  Treasury: [['issueLTDebtAmount','Raise term debt once (£)','Executed next month, then cleared. Provides cash and stable funding, with future interest costs.'],['hedgeNotional','Swap notional (£)','Executed once when a direction is selected.'],['hedgeMaturityMonths','Swap term (months)','The swap remains on the books until maturity.']],
};
