...
export default function RegMetricsPanel({ state, history, config, pendingRiskAppetite, onRiskAppetite }: Props) {
  ...
  return <section className="card regulatory-detail">
    ...
    <p className="muted">2026 UK standardised bank assumptions. Ratios use prescribed factors. Pillar 2A is reassessed annually from the modelled credit, concentration and IRRBB risks and enters minimum requirements; the PRA buffer remains a separate supervisory target. Full regulatory returns and supervisory judgement are outside this model.</p>
