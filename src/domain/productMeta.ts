...
export const PRODUCT_META: Record<ProductType, ProductMetadata> = {
  ...
  [LiabilityProductType.RetailTransactionalDeposits]: { productType: LiabilityProductType.RetailTransactionalDeposits, label: 'Retail transactional deposits (legacy)', side: BalanceSheetSide.Liability, behaviour: { isCustomerDeposit: true, depositSegment: 'retail', affectsBehaviouralDepositFlow: true } },
