...
export const PRODUCT_META: Record<ProductType, ProductMetadata> = {
  ...
  [AssetProductType.ConsumerLoans]: {
    ...
    side: BalanceSheetSide.Asset,
    behaviour: { isLoan: true, affectsBehaviouralLoanFlow: true, loanBenchmark: 'consumer' },
  },
  ...
  [LiabilityProductType.CorporateDeposits]: {
    ...
    label: 'Business deposits (legacy aggregate)',
    side: BalanceSheetSide.Liability,
  ...
  [LiabilityProductType.RetailTermDeposits]: {
    ...
    side: BalanceSheetSide.Liability,
    behaviour: { isCustomerDeposit: true, depositSegment: 'retail', affectsBehaviouralDepositFlow: true, isTermDeposit: true },
  },
  ...
  [LiabilityProductType.BankOfEnglandFunding]: {
    productType: LiabilityProductType.BankOfEnglandFunding,
