...
export const PRODUCT_META: Record<ProductType, ProductMetadata> = {
  ...
  [LiabilityProductType.RetailSavingsDeposits]: { productType: LiabilityProductType.RetailSavingsDeposits, label: 'Instant-access savings', side: BalanceSheetSide.Liability, behaviour: { isCustomerDeposit: true, depositSegment: 'retail', affectsBehaviouralDepositFlow: true } },
