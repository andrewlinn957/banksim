...
const balanceSheet: BalanceSheet = {
  items: [
    ...
    makeItem(BalanceSheetSide.Liability, LiabilityProductType.RetailSavingsDeposits, 'Instant retail', 7.0e9, 0.016785714285714286, MaturityBucket.LessThan1Y),
...
const behaviour: BehaviouralState = {
  ...
  depositRateLagMemory: {
    [LiabilityProductType.RetailSavingsDeposits]: 0.016785714285714286,
  ...
  depositStabilityIndex: {
    [LiabilityProductType.RetailSavingsDeposits]: 1.0760714285714286,
