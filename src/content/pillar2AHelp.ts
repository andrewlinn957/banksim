...
export const pillar2AHelpEntry: MechanicEntry = {
  id: 'pillar-2a-srep',
  category: 'Capital',
  title: 'Pillar 2A and the SREP cycle',
  plainDescription:
    'Pillar 2A is a firm-specific minimum capital requirement for risks that Pillar 1 does not capture, or does not capture adequately. BankSim reassesses variable Pillar 2A once every 24 months from the bank’s balance sheet and risk profile.',
  whyItMatters:
    'The percentage set at the SREP stays in force until the next 24-month review, so decisions can have a delayed capital consequence. The £ requirement still moves with current RWA between reviews.',
  driverSummary: [
    ...
    'Changing concentration, duration or the IRRBB policy limit does not immediately rewrite P2A. The new risk profile is picked up at the next 24-month SREP.',
  ],
  formula:
